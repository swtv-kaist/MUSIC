...
bool ORSN::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
...
void ORSN::Mutate(clang::Expr *e, MusicContext *context)
{
	BinaryOperator *bo;
...
bool ORSN::IsMutationTarget(BinaryOperator *bo, string mutated_token,
