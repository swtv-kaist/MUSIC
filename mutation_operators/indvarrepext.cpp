...
#include "indvarrepext.h"

bool IndVarRepExt::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool IndVarRepExt::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool IndVarRepExt::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // IndVarRepExt can mutate expr that are
...
void IndVarRepExt::Mutate(clang::Expr *e, MusicContext *context)
{
  ...
  for (auto it: (*(context->getSymbolTable()->getFuncNotUsedGlobalList()))[context->getFunctionId()])
  {
...
bool IndVarRepExt::IsIndVar(clang::Expr *e, MusicContext *context)
{
