...
#include "dirvarrepglo.h"

bool DirVarRepGlo::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool DirVarRepGlo::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool DirVarRepGlo::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // DirVarRepGlo can mutate expr that are
...
void DirVarRepGlo::Mutate(clang::Expr *e, MusicContext *context)
{
...
bool DirVarRepGlo::IsDirVar(clang::Expr *e, MusicContext *context)
{
