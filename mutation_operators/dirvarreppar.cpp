...
#include "dirvarreppar.h"

bool DirVarRepPar::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool DirVarRepPar::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool DirVarRepPar::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // DirVarRepPar can mutate expr that are
...
bool DirVarRepPar::IsDirVar(clang::Expr *e, MusicContext *context)
{
