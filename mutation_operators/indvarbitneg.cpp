...
#include "indvarbitneg.h"

bool IndVarBitNeg::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool IndVarBitNeg::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool IndVarBitNeg::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // IndVarBitNeg can mutate expr that are
...
void IndVarBitNeg::Mutate(clang::Expr *e, MusicContext *context)
{
...
bool IndVarBitNeg::IsIndVar(clang::Expr *e, MusicContext *context)
{
