...
#include "indvarlogneg.h"

bool IndVarLogNeg::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool IndVarLogNeg::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool IndVarLogNeg::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // IndVarLogNeg can mutate expr that are
...
void IndVarLogNeg::Mutate(clang::Expr *e, MusicContext *context)
{
...
bool IndVarLogNeg::IsIndVar(clang::Expr *e, MusicContext *context)
{
