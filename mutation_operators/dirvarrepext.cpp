...
#include "dirvarrepext.h"

bool DirVarRepExt::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool DirVarRepExt::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool DirVarRepExt::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // DirVarRepExt can mutate expr that are
...
void DirVarRepExt::Mutate(clang::Expr *e, MusicContext *context)
{
...
bool DirVarRepExt::IsDirVar(clang::Expr *e, MusicContext *context)
{
