...
void VLSF::setRange(std::set<std::string> &range)
{
...
bool VLSF::HandleRangePartition(string option) 
{
  vector<string> words;
...
void VLSF::ApplyRangePartition(vector<string> *range)
{
