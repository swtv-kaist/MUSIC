...
#include "indvarreploc.h"

bool IndVarRepLoc::ValidateDomain(const std::set<std::string> &domain)
{
  return true;
}

bool IndVarRepLoc::ValidateRange(const std::set<std::string> &range)
{
  return true;
}

// Return True if the mutant operator can mutate this expression
bool IndVarRepLoc::IsMutationTarget(clang::Expr *e, MusicContext *context)
{
  ...
  // IndVarRepLoc can mutate expr that are
...
void IndVarRepLoc::Mutate(clang::Expr *e, MusicContext *context)
{
...
bool IndVarRepLoc::IsIndVar(clang::Expr *e, MusicContext *context)
{
