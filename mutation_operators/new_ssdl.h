#ifndef COMUT_NEW_SSDL_H_
#define COMUT_NEW_SSDL_H_ 

#include "mutant_operator_template.h"
#include <iostream>

class NEW_SSDL : public MutantOperatorTemplate
{
public:
	NEW_SSDL(const std::string name = "SSDL")
		: MutantOperatorTemplate(name)
	{}

	// NEW_SSDL only mutates Stmt
	virtual bool CanMutate(clang::Expr *e, ComutContext* context); 
	virtual void Mutate(clang::Expr *e, ComutContext *context);

	// option -A and -B are not available for NEW_SSDL
	// using them for NEW_SSDL terminates COMUT
